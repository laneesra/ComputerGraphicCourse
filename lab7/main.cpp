...
int accuracy = 20; // Точность отрисовки; 46
...
void writeToFile();
void makeTexture();
void countFPS(int &nbFrames, double &lastTime);

int main(){
    if (!glfwInit()) exit(EXIT_FAILURE);

#ifdef DecreaseWindow
    GLFWwindow* window = glfwCreateWindow(300, 300, "Lab7", NULL, NULL);
#else
    GLFWwindow* window = glfwCreateWindow(700, 700, "Lab7", NULL, NULL);
#endif
...
void animation(){
    ...
    if (AnimationMode){
        ...
        bool light = !(on0 == true && on1 == true && on2 == true && on3 == true);
        cylinder = Cylinder(a, b, height, accuracy*0.5, t, light, TextureMode);
    #else
        cylinder = Cylinder(a, b, height, accuracy*0.5, t);
    #endif

#else
    #ifdef LightAndTexture
        bool light = !(on0 == true && on1 == true && on2 == true && on3 == true);
        cylinder = Cylinder(a, b, height, accuracy, t, light, TextureMode);
    #else
...
#ifdef LightAndTexture
    cylinder = Cylinder(a, b, height, accuracy, t, true, TextureMode);
#else
    cylinder = Cylinder(a, b, height, accuracy, t);
#endif
